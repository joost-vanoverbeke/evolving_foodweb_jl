...
data <- 
  read_delim("../results/output_X5_Y3_tl3_loci10_mu0_oe25e-2_d2e-1_dp5e-1_Yrange1e-1_stepLocal2e-3_specPatch_sex_CC2e-4_1e3.csv", 
             delim = ";") %>% 
  bind_rows(read_delim("../results/output_X5_Y3_tl3_loci10_mu1e-4_oe25e-2_d2e-1_dp5e-1_Yrange1e-1_stepLocal2e-3_specPatch_sex_CC2e-4_1e3.csv", 
                       delim = ";")) %>% 
  mutate(scenario = str_c(e_step_CC, time_CC, sep = "_")) 
