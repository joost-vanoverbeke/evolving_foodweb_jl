...
init_values = Init_values(;
    ...
    rep_type = :SEXUAL,
    # species matching
    match_sd_vec = [0.03, 0.1, 0.3, 1., 3., 10.], 
    # trophic levels
    trophic_levels = 2,
    bm_offset = 1.,
    bm_power = 2.,
    ...
    print_steps = 100,
    log_steps = 20,
    output_file = "results/output_X5_Y5_tl2_loci10_mu1e-4_oe25e-2_d2e-1_dp5e-1_Yrange1e-1_stepLocal2e-3_specPatch_sex_CC2e-4_1e3.csv"
);
